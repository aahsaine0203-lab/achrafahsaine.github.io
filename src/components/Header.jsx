    ...
    <header className="header" id="home">
      <div className="animate-fade-in" style={{ animationDelay: '0.2s' }}>
        ...
        <div className="social-links">
          ...
          <a href="https://www.linkedin.com/in/achraf-ahsaine-a21a083ba" target="_blank" rel="noreferrer" className="social-icon" title="LinkedIn"><i className="fa-brands fa-linkedin"></i></a>
